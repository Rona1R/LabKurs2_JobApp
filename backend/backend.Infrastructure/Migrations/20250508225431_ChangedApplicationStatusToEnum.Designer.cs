...
namespace backend.Infrastructure.Migrations
{
    ...
    [Migration("20250508225431_ChangedApplicationStatusToEnum")]
    partial class ChangedApplicationStatusToEnum
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("backend.Domain.Models.SavedJob", b =>
                {
                    ...
                    b.Property<int?>("SavedJobCollectionId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SavedJobCollectionId");
            ...
            modelBuilder.Entity("backend.Domain.Models.SavedJob", b =>
                {
                    ...
                    b.HasOne("backend.Domain.Models.SavedJobCollection", "SavedJobCollection")
                        .WithMany("SavedJobs")
                        .HasForeignKey("SavedJobCollectionId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("SavedJobCollection");
            ...
            modelBuilder.Entity("backend.Domain.Models.User", b =>
                {
                    ...
                    b.Navigation("SavedJobCollections");
