...
export default function DeleteInstitutions(props) {
  ...
  const handleDelete = async () => {
    setLoading(true);
    try {
      await institutionService.delete(props.id);
      props.refresh();
      showNotification("success","Institution was successfully deleted!");
      props.handleClose();
    } catch (err) {
      ...
      >
        ...
        <Modal.Body>
          <Typography variant="h5">
            Are you sure that you want to delete the Institution{" "}
