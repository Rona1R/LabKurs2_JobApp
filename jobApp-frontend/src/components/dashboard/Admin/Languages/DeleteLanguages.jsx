...
export default function DeleteLanguages(props) {
  ...
  const handleDelete = async () => {
    setLoading(true);
    try {
      await languageService.delete(props.id);
      props.refresh();
      showNotification("success","Language was successfully deleted!");
      props.handleClose();
    } catch (err) {
      ...
      >
        ...
        <Modal.Body>
          <Typography variant="h5">
            Are you sure that you want to delete the Language{" "}
