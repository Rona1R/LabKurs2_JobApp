  ...
  const columns = [
    ...
    },
    {
      ...
      renderCell: (params) => {
        ...
        switch (status) {
            case "Pending":
            icon = <i className="fa-regular fa-clock" style={{ color: "#F57C00", marginRight: 8 }} />;
            color = "#F57C00";
            break;
            case "InReview":
            icon = <i className="fa-solid fa-hourglass-half" style={{ color: "#1565c0", marginRight: 8 }} />;
            color = "#1565c0"; 
            break;
          case "Approved":
            icon = <i className="fa-solid fa-circle-check" style={{ color: "#3c2ca6", marginRight: 8 }} />;
            color = "#3c2ca6"; 
            break;
            case "Withdrawn":
            icon = <i className="fa-solid fa-arrow-rotate-left" style={{ color: "#757575", marginRight: 8 }} />;
            color = "#757575"; 
            break;
          default:
            icon = <i className="fa-regular fa-question-circle" style={{ color: "#90A4AE", marginRight: 8 }} />;
            color = "#90A4AE"; 
        }
        return (
          <span
